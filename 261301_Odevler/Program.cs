namespace _261301_Odevler
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //kullanıcıdan alınan 4 sayı için aşağıdaki işlemlerin sonuçlarını hesaplayıp ekranda gösteriniz.
            //1. işlem--  1- 4 sayının toplamı
            //2. işlem-- 2- 1. 2. sayıların çarpım sonucuna 5. sayıya bölme
            //3. işlem-- 3- 1. ve 2. sayıların toplam sonucu, 3. sayıdan 4. sayının çıkartılması sonucu bölüm
            //4. işlem-- 4- 4. sayıya diğer 3 sayının toplamına bölünmesi
            //5. işlem-- 5- 1. 2. 3. sayiların çarpımının sonucunun 4 sayıya bölünmesi
            ...
            //1
            int islem1 = sayi1 + sayi4;
            Console.WriteLine("1. sayi ve 4. sayinin toplamı: " + islem1);

            //2
            double islem2 = (double)(sayi1 * sayi2) / (sayi5);
            Console.WriteLine("1. ve 2 sayinin carpim sonucunu 5. sayiya bolme" + islem2);
